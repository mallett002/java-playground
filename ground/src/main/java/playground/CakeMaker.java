...
public class CakeMaker {
    ...
    private boolean wetIngredientsMixed = false;
    private boolean dryIngredientsMixed = false;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            combineIngredients.start(); // Can't start until dry and wet ingredients are done
    ...
    public void combineIngredients() {
        try {
            synchronized(this) {
                boolean wetAndDryIngredientsReady = wetIngredientsMixed && dryIngredientsMixed;
                while(!wetAndDryIngredientsReady) {
                    printTask("Waiting for wet and dry ingredients to be ready...");
                    wait();
                }
            }
